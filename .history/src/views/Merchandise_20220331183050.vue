<template>
  <section id="merchandise">
      <div class="content-titlewrapper" data-aos="fade-up">
        ...
        <p class="content-title" data-aos="fade-up">水煎包</p>
        <i class="decoration" data-aos="fade-up"></i>
      </div>
      <p class="content-description" data-aos="fade-up">
        ...
        <div class="cardwrapper" data-aos="fade-up" data-aos-offset="200">
...
export default {
    data:()=>({
        ...
        content:"主要賣三種水煎包，內餡分別為高麗菜、筍子、冬粉，每個售價15元，飲料有 紅茶、奶茶 另售10元"
    }),
    // data(){
    //     return{
    //         cardcontent:"一個15元",
